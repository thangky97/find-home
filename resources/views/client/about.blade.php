                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('client/img/icons/icon-img/21.png') }}" alt="#">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('client/img/icons/icon-img/22.png') }}" alt="#">
                        </div>
                        <div class="ltn__feature-info">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('client/img/icons/icon-img/23.png') }}" alt="#">
                        </div>
                        <div class="ltn__feature-info">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="{{ asset('client/img/team/4.jpg') }}" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="{{ asset('client/img/team/2.jpg') }}" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="{{ asset('client/img/team/5.jpg') }}" alt="Image">
                        </div>
                        <div class="team-info">
