                                ...
                                <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('client/img/product-3/1.jpg') }}" alt="#"></a>
                                                <div class="real-estate-agent">
                                                    <div class="agent-img">
                                                        <a href="team-details.html"><img
                                                                src="{{ asset('client/img/blog/author.jpg') }}"
                                                                alt="#"></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('client/img/product-3/2.jpg') }}" alt="#"></a>
                                                <div class="real-estate-agent">
                                                    <div class="agent-img">
                                                        <a href="team-details.html"><img
                                                                src="{{ asset('client/img/blog/author.jpg') }}"
                                    ...
                                    <div class="col-xl-6 col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('client/img/product-3/3.jpg') }}"
                                                        alt="#"></a>
                                                <div class="real-estate-agent">
                                                    <div class="agent-img">
                                                        <a href="team-details.html"><img
                                    ...
                                    <div class="col-xl-6 col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="product-img">
                                                <a href="product-details.html"><img
                                                        src="{{ asset('client/img/product-3/4.jpg') }}"
                                                        alt="#"></a>
                                                <div class="real-estate-agent">
                                                    <div class="agent-img">
                                                        <a href="team-details.html"><img
